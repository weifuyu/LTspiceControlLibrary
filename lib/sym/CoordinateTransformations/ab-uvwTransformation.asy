...
SYMATTR Prefix X
SYMATTR SpiceModel ab-uvwTransformation
SYMATTR Description u=K*a v=-u-w w=K*(-1/2*a-sqrt(3)/2*b): Two-phase (alpha,beta,zero=0) to three-phase (u,v=-u-w,w) transformation. (default K=sqrt(2/3))
SYMATTR ModelFile CoordinateTransformations.lib
PIN 0 48 LEFT 8
PINATTR PinName a
