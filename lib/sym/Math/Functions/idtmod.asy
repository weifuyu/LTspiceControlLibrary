...
TEXT 48 -32 Center 2 idtmod
SYMATTR Prefix X
SYMATTR SpiceModel idtmod
SYMATTR Description idtmod(x): Integrate x, optional initial condition ic, reset on reaching modulus m, offset output by o.
