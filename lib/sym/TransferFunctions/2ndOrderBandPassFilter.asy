...
TEXT 88 -42 Center 2 K(2zws)
TEXT 88 -22 Center 2 s^2+2zws+w^2
WINDOW 3 0 0 Left 2
SYMATTR Value K=1 w=1 z=1
SYMATTR Prefix X
SYMATTR SpiceModel 2ndOrderBandPassFilter
SYMATTR Description K(2zws)/(s^2+2zws+w^2): 2nd order band pass filter element. (default K=1 w=1 z=1)
SYMATTR ModelFile TransferFunctions.lib
PIN 192 -32 NONE 8
PINATTR PinName Y
