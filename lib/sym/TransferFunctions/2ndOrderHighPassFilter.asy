...
TEXT 88 -42 Center 2 Ks^2
TEXT 88 -22 Center 2 s^2+2zws+w^2
WINDOW 3 0 0 Left 2
SYMATTR Value K=1 w=1 z=1
SYMATTR Prefix X
SYMATTR SpiceModel 2ndOrderHighPassFilter
SYMATTR Description (Ks^2)/(s^2+2zws+w^2): 2nd order high pass filter element. (default K=1 w=1 z=1)
